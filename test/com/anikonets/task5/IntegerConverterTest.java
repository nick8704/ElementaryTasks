...
class IntegerConverterTest {
    ...
    void shouldNumberToString7() {
        ...
        String actual = IntegerConverter.numberToString(0, Language.UK);
        assertEquals(expected, actual);
    }
    ...
    void shouldNumberToString8() {
        ...
        String actual = IntegerConverter.numberToString(-52700843, Language.UK);
        assertEquals(expected, actual);
    }
    ...
    void shouldNumberToString9() {
        ...
        String actual = IntegerConverter.numberToString(93517, Language.UK);
        assertEquals(expected, actual);
    }
